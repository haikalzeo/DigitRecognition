...
st.markdown("*Please press ⬇️ Send Button in the bottom left of the canvas after you're done with your drawing, otherwise an error may occur!")
...
digitRecognition_SVM_Model = joblib.load("DigitRecognition_SVM_Model.pt")
